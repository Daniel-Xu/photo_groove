...
var _user$project$PhotoGroove$Surprise = {ctor: 'Surprise'};
var _user$project$PhotoGroove$SelectPhoto = function (a) {
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					A2(_elm_lang$core$Basics_ops['++'], _user$project$PhotoGroove$urlPrefix, photo.url)),
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							ctor: '_Tuple2',
							_0: 'selected',
							_1: _elm_lang$core$Native_Utils.eq(selectedUrl, photo.url)
						}
						])),
					_elm_lang$html$Html_Events$onClick(
					_user$project$PhotoGroove$SelectPhoto(photo.url))
				]),
			_elm_lang$core$Native_List.fromArray(
				[]));
	});
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(_user$project$PhotoGroove$Surprise)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
				...
				A2(
					...
					_user$project$PhotoGroove$initialModel.photos)),
				A2(
				_elm_lang$html$Html$img,
				_elm_lang$core$Native_List.fromArray(
					[
